    ...
    <footer className={`w-full bg-white border-t border-black/[0.06] ${className ?? ""}`}>
      <div className="container-pro py-14 md:py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-14">
          ...
          <div className="md:col-span-2 space-y-4">
            <div className="flex items-center gap-2.5">
              <svg
                viewBox="0 0 24 24"
                aria-hidden
                className="h-[22px] w-[22px] fill-[#1d1d1f] shrink-0"
          ...
          {/* Links */}
          <div>
            <h4 className="text-[12px] font-semibold text-[#86868b] tracking-[-0.01em] mb-4">Navigation</h4>
          ...
          <div>
            <h4 className="text-[12px] font-semibold text-[#86868b] tracking-[-0.01em] mb-4">Support</h4>
            <ul className="space-y-2.5">
              {[
          ...
          <div>
            <h4 className="text-[12px] font-semibold text-[#86868b] tracking-[-0.01em] mb-4">Vendeurs</h4>
            <ul className="space-y-2.5">
              {[
